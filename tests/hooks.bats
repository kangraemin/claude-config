...
@test "notion-worklog: missing NOTION_TOKEN (no .env) - fails with error" {
  ...
  run bash -c "NOTION_TOKEN='' NOTION_DB_ID='' bash $HOME/.claude/scripts/notion-worklog.sh 'title' '2026-03-01' 'proj' 100 0.5 1 'claude-opus-4-6' 500 2.0 'content'"
...
@test "notion-worklog: missing NOTION_DB_ID - fails with specific error" {
  run bash -c "NOTION_TOKEN='fake_token' NOTION_DB_ID='' bash $HOME/.claude/scripts/notion-worklog.sh 'title' '2026-03-01' 'proj' 100 0.5 1 'claude-opus-4-6' 500 2.0 'content'"
  [ "$status" -ne 0 ]
  [[ "$output" == *"NOTION_DB_ID"* ]]
}
...
@test "notion-worklog: auto-sources .env for NOTION_TOKEN" {
  ...
  run bash -c "NOTION_DB_ID='' bash $HOME/.claude/scripts/notion-worklog.sh 'title' '2026-03-01' 'proj' 100 0.5 1 'claude-opus-4-6' 500 2.0 'content'"
  [ "$status" -ne 0 ]
